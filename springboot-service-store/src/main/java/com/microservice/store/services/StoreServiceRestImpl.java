...
public class StoreServiceRestImpl implements StoreService {
	...
	public List<Store> findAll() {
		List<Celular> celulares = Arrays.asList(clientRest.getForObject("https://localhost:8082/list", Celular[].class));
	...
	public Store findById(Long id, Integer cantidad) {
		...
		Celular cel = clientRest.getForObject("https://localhost:8082/celular/{id}", Celular.class, pathVariables);
